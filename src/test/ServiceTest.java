...
//		Client client = Client.create();	
//		WebResource resource = client.resource("http://localhost:8080/omg/rest/courts");
//		String ansString = null;
//		try {
//			ansString = resource.accept(MediaType.APPLICATION_JSON).get(String.class);
//		System.out.println(ansString);
//		} catch (Exception e) {
//			// TODO: handle exception
//			e.printStackTrace();
...
//	}
	...
	public void testGetOrders(){
		Client client = Client.create();	
		WebResource resource = client.resource("http://localhost:8080/omg/rest/order");
		String ansString = null;
		try {
			Form form = new Form();
			form.add("token", "3f6fd659-f718-4d8c-8c70-96692efe0400");
			ClientResponse response = resource.type(MediaType.APPLICATION_FORM_URLENCODED)
			   .post(ClientResponse.class, form);
			ansString = response.getEntity(String.class);
		System.out.println(ansString);
		} catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
